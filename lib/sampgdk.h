...
/**
 * \ingroup natives
 * \see <a href="http://wiki.sa-mp.com/wiki/UpdateDynamic3DTextLabelText">UpdateDynamic3DTextLabelText on SA-MP Wiki</a>
 */
...
inline bool UpdateDynamic3DTextLabelText(int id, int color, const char* text)
{
